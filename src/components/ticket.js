                ...
                <div className="box">
                  <div className="dropdown visiter-icon">
                    ...
                    <div className="dropdown-menu">
                      ...
                      <a > <img src={"http://www.kyazoonga.com/images/rsvp-blank-1.jpg"} alt="img"/> </a>
                      <a > <img src={"http://www.kyazoonga.com/images/rsvp-blank-1.jpg"} alt="img"/> </a>
                      <a > <img src={"http://www.kyazoonga.com/images/rsvp-blank-1.jpg"} alt="img"/> </a>
                      <a > <img src={"http://www.kyazoonga.com/images/rsvp-blank-1.jpg"} alt="img"/> </a>
                      <a > <img src={"http://www.kyazoonga.com/images/rsvp-blank-1.jpg"} alt="img"/> </a>
                  ...
                  <div className="social clearfix">
                    <div className="pull-left">
                      <a className="btn btn-default btn-xs ical" >
                    <i className="fa fa-calendar"></i> &nbsp;iCal</a>
                      <a className="btn btn-default btn-xs ml-10" >
                    <i className="fa fa-calendar"></i> &nbsp;Google</a>
                    </div>
                    <div className="pull-right">
                      <a className="btn btn-default btn-xs btn-circle" >
